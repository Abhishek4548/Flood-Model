...
def train_flood_model():
    ...
    historical_data = pd.read_csv(r'C:\Users\abhi1\Desktop\Dakshina Kannada\backend\data\Dakshina Kannada 2021-06-01 to 2023-12-31.csv')
...
def add_new_data_to_training_set(city, day, predicted_flood_risk, actual_flood_risk):
    ...
    full_data.to_csv(r'C:\Users\abhi1\Desktop\Dakshina Kannada\backend\data\Dakshina Kannada 2021-06-01 to 2023-12-31.csv', index=False)
